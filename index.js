    ...
    repo_btn.addEventListener("click", function (e) {
        ...
        for (var i = 0; i <= class_count.length - 1; i++) {
            ...
            for (var i = 0; i <= command_count.length - 1; i++) {
                ...
                let this_target_slt_value = this_commmand_div.getElementsByClassName("target_slt")[0] && this_commmand_div.getElementsByClassName("target_slt")[0].value;
                let this_command_text_1_value = this_commmand_div.getElementsByClassName("command_text_1")[0] && this_commmand_div.getElementsByClassName("command_text_1")[0].value;
                let this_command_text_2_value = this_commmand_div.getElementsByClassName("command_text_2")[0] && this_commmand_div.getElementsByClassName("command_text_2")[0].value;
